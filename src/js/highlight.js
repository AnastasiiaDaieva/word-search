...
HighlightInTextarea.prototype = {
  ...
  fixFirefox: function () {
    ...
    this.backdrop.style.marginTop =
      bdMarginTopOldValue + padding['padding-top'] + border['border-top-width'] + 'px';
...
// ==========================================
HighlightInTextarea.instance('.form-input', {
  highlight: [
    {
      highlight: [
        'writer',
        ...
        'pass plagiarism scan',
        'tailored academic papers',
        'strictly against plagiarism',
        'boost grades',
        'enhance your academic grade',
        "If you don't want to write an essay",
        'to write',
